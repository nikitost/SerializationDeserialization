//переработанный словарь для сериализации и десериализации в Xml формат
//стандартный словарь из Collections.Generic невозможно сериализовать используя System.Xml.Serialization
//Author: Michał Jankowski
//Web: jankowskimichal.pl/en/2010/10/serializabledictionary/
